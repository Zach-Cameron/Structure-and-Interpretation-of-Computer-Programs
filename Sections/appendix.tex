...
\begin{defn}[\idx{conditional expression}]
    ...
    \begin{itemize}
        \item Let $i=1$.
        \item If the value of $p_{i}$ is undefined, then the value of the conditional statement is undefined.
        \item If the value of $p_{i}$ is $T$, then the value of the conditional statement is the value of the expression $e_{i}$.
